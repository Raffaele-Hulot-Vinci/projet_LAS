 ...
 *       meaning all signals are blocked during handler's execution. 
 ...
 * RES: return true if success; false otherwise
 */
 ...
 * PRE: fds: tableau contenant nb file descriptors
 *      fds_invalid: tableau de nb booléens indiquant si le fd correspondant de fds est invalide
 * RES: renvoie l'indice d'un fd du tableau fds qui n'est pas indiqué comme invalide dans
 *      le tableau fds_invalide et sur lequel des données peuvent être lues ;
 *      renvoie -1 si aucun fd valide sur lequel des données sont disponibles n'a pu être trouvé
 */
